<?php
 ...
 $q = "UPDATE room set RoomNo=$roomno, RoomType='$roomtype', RoomStatus='$roomstatus', Person='$person' where RoomNo=$roomno";
...
<body>
 ...
 <h1 class="text-white text-center">  Update Room </h1>
 </div><br>
